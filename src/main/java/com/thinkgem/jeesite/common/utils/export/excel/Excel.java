package com.thinkgem.jeesite.common.utils.export.excel;

import com.thinkgem.jeesite.common.utils.DateUtils;
import com.thinkgem.jeesite.common.utils.StringUtils;
import com.thinkgem.jeesite.common.utils.export.ExcelUtils.ByteUtils;
import com.thinkgem.jeesite.common.utils.export.ExcelUtils.ClassUtils;
        ...
        for (int rownum = 0; rownum < datas.size(); rownum++) {
            ...
            for (int cellnum = 0; cellnum < keys.length; cellnum++) {
                ...
                if ((keys[cellnum].toString().toLowerCase().contains("time")
                    ...
                    cell.setCellValue(DateUtils.formatDate((Date) value, "MM月dd日"));
                    cellStyle.setAlignment(XSSFCellStyle.ALIGN_CENTER);
                    cellStyle.setVerticalAlignment(XSSFCellStyle.VERTICAL_CENTER);
                    cell.setCellStyle(cellStyle); // 设置单元格样式
                } else {
                    if (style != null) {
                        if (keys[cellnum].equals("gg")){
                        ...
                        if (value instanceof Number) {
                            ...
                            if (value == null) {
                                ...
                                if (StringUtils.isInteger(value.toString()) && StringUtils.isNotBlank(value.toString())) {
                                    cell.setCellValue(Double.parseDouble(value.toString()));
                                } else {
