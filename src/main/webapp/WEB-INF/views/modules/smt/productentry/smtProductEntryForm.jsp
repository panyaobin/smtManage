...
<body>
	...
	<form:form id="inputForm" modelAttribute="smtProductEntry" action="${ctx}/smt/productentry/smtProductEntry/save" onkeypress="return event.keyCode != 13;" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">成品入库序列ID：</label>
			<div class="controls">
				<form:input path="peId" htmlEscape="false" maxlength="11" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="customerNo" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">成品入库数量：</label>
			<div class="controls">
				<form:input path="entryCounts" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">产品类型：</label>
			<div class="controls">
				<form:input path="productType" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="smt:productentry:smtProductEntry:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
