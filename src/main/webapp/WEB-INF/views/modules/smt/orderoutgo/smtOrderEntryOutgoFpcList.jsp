    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnExport").click(function () {
                ...
                window.location.href="${ctx}/smt/orderoutgo/smtOrderOutgo/export?customerNo="+customerNo+"&productNo="+productNo+"&orderNo="+orderNo;
            });
        });
...
<ul class="nav nav-tabs">
    <shiro:hasPermission name="smt:orderentry:smtOrderEntry:view">
        <li class="active"><a href="${ctx}/smt/orderoutgo/smtOrderOutgo/order_entry_fpc_list">在线主FPC待出货</a></li>
    </shiro:hasPermission>
...
<form:form id="searchForm" modelAttribute="smtOrderEntry" action="${ctx}/smt/orderoutgo/smtOrderOutgo/order_entry_fpc_list" method="post" class="breadcrumb form-search">
    ...
    <ul class="ul-form">
        ...
        <li class="btns"><input id="btnReset" class="btn btn-primary" type="reset" onclick="window.location.href='${ctx}/smt/orderoutgo/smtOrderOutgo/order_entry_fpc_list'" value="重置"/></li>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="smtOrderEntry" varStatus="oe">
        <tr>
            ...
            <shiro:hasPermission name="smt:orderentry:smtOrderEntry:edit">
                <td>
                    <a href="${ctx}/smt/orderoutgo/smtOrderOutgo/outgo?id=${smtOrderEntry.id}">出货</a>
                </td>
            </shiro:hasPermission>
        </tr>
    </c:forEach>
