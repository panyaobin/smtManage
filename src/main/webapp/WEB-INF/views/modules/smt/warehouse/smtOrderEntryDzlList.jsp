...
<ul class="nav nav-tabs">
    <shiro:hasPermission name="smt:orderentry:smtOrderEntry:view">
        ...
        <li class="active"><a href="${ctx}/smt/orderentry/smtOrderEntry/dzl_list">电子料仓</a></li>
...
<form:form id="searchForm" modelAttribute="smtOrderEntry" action="${ctx}/smt/orderentry/smtOrderEntry/dzl_list" method="post" class="breadcrumb form-search">
    ...
    <ul class="ul-form">
        ...
        <li class="btns"><input id="btnReset" class="btn btn-primary" type="reset" onclick="window.location.href='${ctx}/smt/orderentry/smtOrderEntry/dzl_list'" value="重置"/></li>
