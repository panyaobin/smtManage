...
<div style="padding-left: 200px;padding-top: 20px;">
    <p style="text-align: left">
        ...
        <span><img style="" src="${ctxStatic}/ckeditor/images/jiantou.png"/></span>
    ...
    <span style="text-align: left!important;margin-left: 22px"><img style="" src="${ctxStatic}/ckeditor/images/jiantouxia.png"/></span>
    <div style="display: inline;margin-left: 320px">
        <img style="" src="${ctxStatic}/ckeditor/images/logo.jpg"/>
