...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="smt:orderonline:smtOrderOnline:edit">
        <li class="active"><a href="${ctx}/smt/orderonline/smtOrderOnline/dzl_list">电子料结存</a></li>
    </shiro:hasPermission>
    <shiro:hasPermission name="smt:orderonline:smtOrderOnline:edit">
...
<form:form id="searchForm" modelAttribute="smtOrderOnline" action="${ctx}/smt/orderonline/smtOrderOnline/dzl_list" method="post" class="breadcrumb form-search">
    ...
    <ul class="ul-form">
        ...
        <li class="btns"><input id="btnReset" class="btn btn-primary" type="reset" onclick="window.location.href='${ctx}/smt/orderonline/smtOrderOnline/dzl_list'" value="重置"/></li>
