...
<table id="contentTable"  class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="smtOrderOutgo" varStatus="out">
        <tr>
            ...
            <td>
                   <a href="javascript:void(0)" title="打印预览" onclick='window.location.href="${ctx}/smt/orderoutgo/smtOrderOutgo/reprint_outgo?outgoOrderNo=${smtOrderOutgo.outgoOrderNo}"'>${smtOrderOutgo.outgoOrderNo}</a>
            </td>
            <td>
